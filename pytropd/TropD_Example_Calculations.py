...
f_V = netcdf_file(os.path.join(dirname, 'ValidationData/va.nc'),'r')
...
f_T = netcdf_file(os.path.join(dirname, 'ValidationData/ta.nc'),'r')
f_Z = netcdf_file(os.path.join(dirname, 'ValidationData/zg.nc'),'r')
...
f_olr = netcdf_file(os.path.join(dirname, 'ValidationData/rlnt.nc'),'r')
f_olrcs = netcdf_file(os.path.join(dirname, 'ValidationData/rlntcs.nc'),'r')
...
f_U = netcdf_file(os.path.join(dirname, 'ValidationData/ua.nc'),'r')
...
f_pr = netcdf_file(os.path.join(dirname, 'ValidationData/pr.nc'),'r')
# read zonal mean monthly evaporation drived from surface latent heat flux hfls(time,lat)
f_er = netcdf_file(os.path.join(dirname, 'ValidationData/hfls.nc'),'r')
...
f_uas = netcdf_file(os.path.join(dirname, 'ValidationData/uas.nc'),'r')
U = f_U.variables['ua'][:].copy()
...
f_ps = netcdf_file(os.path.join(dirname, 'ValidationData/psl.nc'),'r')
...
ps_ANN = pytf.TropD_Calculate_Mon2Season(ps, season=np.arange(12))
...
f_Phi = netcdf_file(os.path.join(dirname, 'ValidationMetrics/PSI_ANN.nc'),'r')
Phi_nh = f_Phi.variables['PSI_NH'][:].copy()
Phi_sh = f_Phi.variables['PSI_SH'][:].copy()
f_Phi.close()
...
f_Phi = netcdf_file(os.path.join(dirname, 'ValidationMetrics/PSI.nc'),'r')
Phi_nh = f_Phi.variables['PSI_NH'][:].copy()
Phi_sh = f_Phi.variables['PSI_SH'][:].copy()
f_Phi.close()
...
f_Phi = netcdf_file(os.path.join(dirname, 'ValidationMetrics/TPB_ANN.nc'),'r')
Phi_nh = f_Phi.variables['TPB_NH'][:].copy()
Phi_sh = f_Phi.variables['TPB_SH'][:].copy()
f_Phi.close()
...
f_Phi = netcdf_file(os.path.join(dirname, 'ValidationMetrics/TPB.nc'),'r')
Phi_nh = f_Phi.variables['TPB_NH'][:].copy()
Phi_sh = f_Phi.variables['TPB_SH'][:].copy()
f_Phi.close()
...
ps_DJF = pytf.TropD_Calculate_Mon2Season(ps, season=np.array([0,1,11]))
ps_MAM = pytf.TropD_Calculate_Mon2Season(ps, season=np.array([2,3,4]))
ps_JJA = pytf.TropD_Calculate_Mon2Season(ps, season=np.array([5,6,7]))
ps_SON = pytf.TropD_Calculate_Mon2Season(ps, season=np.array([8,9,10]))
...
f_Phi = netcdf_file(os.path.join(dirname, 'ValidationMetrics/PSL_DJF.nc'),'r')
Phi_nh = f_Phi.variables['PSL_NH'][:].copy()
Phi_sh = f_Phi.variables['PSL_SH'][:].copy()
f_Phi.close()
...
f_Phi = netcdf_file(os.path.join(dirname, 'ValidationMetrics/PSL_JJA.nc'),'r')
Phi_nh = f_Phi.variables['PSL_NH'][:].copy()
Phi_sh = f_Phi.variables['PSL_SH'][:].copy()
f_Phi.close()
...
f_Phi = netcdf_file(os.path.join(dirname, 'ValidationMetrics/PSL_MAM.nc'),'r')
Phi_nh = f_Phi.variables['PSL_NH'][:].copy()
Phi_sh = f_Phi.variables['PSL_SH'][:].copy()
f_Phi.close()
...
f_Phi = netcdf_file(os.path.join(dirname, 'ValidationMetrics/PSL_SON.nc'),'r')
Phi_nh = f_Phi.variables['PSL_NH'][:].copy()
Phi_sh = f_Phi.variables['PSL_SH'][:].copy()
f_Phi.close()
...
f_Phi = netcdf_file(os.path.join(dirname, 'ValidationMetrics/EDJ_ANN.nc'),'r')
Phi_nh = f_Phi.variables['EDJ_NH'][:].copy()
Phi_sh = f_Phi.variables['EDJ_SH'][:].copy()
f_Phi.close()
...
f_Phi = netcdf_file(os.path.join(dirname, 'ValidationMetrics/EDJ.nc'),'r')
Phi_nh = f_Phi.variables['EDJ_NH'][:].copy()
Phi_sh = f_Phi.variables['EDJ_SH'][:].copy()
f_Phi.close()
...
f_Phi = netcdf_file(os.path.join(dirname, 'ValidationMetrics/STJ_ANN.nc'),'r')
Phi_nh = f_Phi.variables['STJ_NH'][:].copy()
Phi_sh = f_Phi.variables['STJ_SH'][:].copy()
f_Phi.close()
...
f_Phi = netcdf_file(os.path.join(dirname, 'ValidationMetrics/STJ.nc'),'r')
Phi_nh = f_Phi.variables['STJ_NH'][:].copy()
Phi_sh = f_Phi.variables['STJ_SH'][:].copy()
f_Phi.close()
...
f_Phi = netcdf_file(os.path.join(dirname, 'ValidationMetrics/OLR_ANN.nc'),'r')
Phi_nh = f_Phi.variables['OLR_NH'][:].copy()
Phi_sh = f_Phi.variables['OLR_SH'][:].copy()
f_Phi.close()
...
f_Phi = netcdf_file(os.path.join(dirname, 'ValidationMetrics/OLR.nc'),'r')
Phi_nh = f_Phi.variables['OLR_NH'][:].copy()
Phi_sh = f_Phi.variables['OLR_SH'][:].copy()
f_Phi.close()
...
f_Phi = netcdf_file(os.path.join(dirname, 'ValidationMetrics/PE_ANN.nc'),'r')
Phi_nh = f_Phi.variables['PE_NH'][:].copy()
Phi_sh = f_Phi.variables['PE_SH'][:].copy()
f_Phi.close()
...
f_Phi = netcdf_file(os.path.join(dirname, 'ValidationMetrics/PE.nc'),'r')
Phi_nh = f_Phi.variables['PE_NH'][:].copy()
Phi_sh = f_Phi.variables['PE_SH'][:].copy()
f_Phi.close()
...
f_Phi = netcdf_file(os.path.join(dirname, 'ValidationMetrics/UAS_ANN.nc'),'r')
Phi_nh = f_Phi.variables['UAS_NH'][:].copy()
Phi_sh = f_Phi.variables['UAS_SH'][:].copy()
f_Phi.close()
...
f_Phi = netcdf_file(os.path.join(dirname, 'ValidationMetrics/UAS.nc'),'r')
Phi_nh = f_Phi.variables['UAS_NH'][:].copy()
Phi_sh = f_Phi.variables['UAS_SH'][:].copy()
f_Phi.close()
